...
bool HelloWorld::init()
{
    ...
    /////////////////////////////
	Label* lb1 = Label::createWithSystemFont("scene 1: HaiZei", "Arial", 24);
	lb1->setPosition(Point(origin.x + visibleSize.width / 2 ,
		origin.y + visibleSize.height - 50));
	this->addChild(lb1, 1);

	// 创建精灵对象
	Sprite* sp = Sprite::create("sara\\01.png");
	...
	listen->onTouchEnded = [=](cocos2d::Touch* touch, cocos2d::Event *event){
		...
		//
		auto actions = Spawn::create(action,NULL);
		sp->runAction(actions);
